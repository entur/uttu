...
public class ValidationHelperTest {
  ...
  public void isNotAfter_whenOtherLocalTimeIsGreater_shouldBeTrue() {
    Assert.assertTrue(
      ValidationHelper.isNotAfter(LocalTime.of(10, 0), 0, LocalTime.of(10, 1), 0)
    );
  }
  ...
  public void isNotAfter_whenEqual_shouldBeTrue() {
    Assert.assertTrue(
      ValidationHelper.isNotAfter(LocalTime.of(10, 0), 0, LocalTime.of(10, 0), 1)
    );
  }
  ...
  public void isNotAfter_whenOtherLocalTimeIsSmaller_shouldBeFalse() {
    Assert.assertFalse(
      ValidationHelper.isNotAfter(LocalTime.of(10, 1), 0, LocalTime.of(10, 0), 0)
    );
  }
}
