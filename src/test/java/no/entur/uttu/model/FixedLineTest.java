...
public class FixedLineTest {
  ...
  public void checkPersistable_whenUsingFlexibleStopPlace_giveException() {
    ...
    StopPointInJourneyPattern secondStopPointInJourneyPattern =
    ...
    journeyPattern.setPointsInSequence(
      Arrays.asList(stopPointInJourneyPattern, secondStopPointInJourneyPattern)
    );
    fixedLine.setJourneyPatterns(Collections.singletonList(journeyPattern));
    assertCheckPersistableFailsWithErrorCode(
      fixedLine,
      ErrorCodeEnumeration.FLEXIBLE_STOP_PLACE_NOT_ALLOWED
    );
  }
}
