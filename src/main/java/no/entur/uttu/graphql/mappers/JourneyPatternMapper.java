...
public class JourneyPatternMapper extends AbstractGroupOfEntitiesMapper<JourneyPattern> {
  ...
  public JourneyPatternMapper(
    ProviderRepository providerRepository,
    ProviderEntityRepository<JourneyPattern> repository,
    ServiceJourneyMapper serviceJourneyMapper,
    StopPointInJourneyPatternMapper stopPointInJourneyPatternMapper
  ) {
