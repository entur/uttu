...
public abstract class AbstractGroupOfEntitiesMapper<
  T extends GroupOfEntities_VersionStructure
>
  extends AbstractProviderEntityMapper<T> {

  public AbstractGroupOfEntitiesMapper(
  ...
  public T map(Object input) {
    return populateGroupOfEntitiesFieldsFromInput(
      super.map(input),
