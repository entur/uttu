        ...
        newFieldDefinition()
          ...
          .argument(
            GraphQLArgument
              ...
              .description("First stop point's longitude")
              .build()
          )
          .argument(
            GraphQLArgument
              ...
              .name("latitudeFrom")
              .type(GraphQLBigDecimal)
              .description("First stop point's latitude")
              .build()
          )
          .argument(
            GraphQLArgument
              ...
              .name("longitudeTo")
              .type(GraphQLBigDecimal)
              .description("Second stop point's longitude")
              .build()
          )
          .argument(
            GraphQLArgument
              ...
              .name("latitudeTo")
              .type(GraphQLBigDecimal)
              .description("Second stop point's latitude")
              .build()
          )
          .argument(
            GraphQLArgument
          ...
          .description("Service link with route geometry")
